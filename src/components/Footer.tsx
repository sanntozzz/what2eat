    ...
    return (
        <>
            <svg
                ...
                className="h-20 w-full bg-orange-400"
            >
                <path
            ...
            <div className="bg-orange-400 text-white">
                <div className="space-y-2 px-4 pb-6 text-center text-sm">
                    <p>Developed by João F.C. Santos</p>
                    ...
                    <p className="mx-auto max-w-screen-md text-xs">
